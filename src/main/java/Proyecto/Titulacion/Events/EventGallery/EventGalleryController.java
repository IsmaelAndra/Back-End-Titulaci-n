...
public class EventGalleryController {
    ...
    @Operation(summary = "gets an event gallery for your id, requires hasAnyRole")
    @GetMapping("/{id}/")
    ...
    @Operation(summary = "updates an event gallery by its id, requires hasAnyRole(ADMIN)")
    @PutMapping("/{id}/")
    @PreAuthorize("hasAnyRole('ADMIN')")
    ...
    @Operation(summary = "removes an event gallery by its id, requires hasAnyRole(ADMIN)")
    @DeleteMapping("/{id}/")
    @PreAuthorize("hasAnyRole('ADMIN')")
    ...
    @Operation(summary = "partial updates an event gallery by its id, requires hasAnyRole(ADMIN)")
    @PatchMapping("/{id}/")
    @PreAuthorize("hasAnyRole('ADMIN')")
