...
public class StudentProjectController {
    ...
    public StudentProject findById( @PathVariable long id ){
    ...
    @PatchMapping("/{id}/")
    @PreAuthorize("hasAnyRole('ADMIN','EMPRENDEDOR')")
    public StudentProject partialUpdate(@PathVariable long id, @RequestBody Map<String, Object> fields){

        StudentProject entity = findById(id);
